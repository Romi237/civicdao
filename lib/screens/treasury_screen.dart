              ...
              children: _txns.asMap().entries.map((e) {
                ...
                return Column(children: [
                  Padding(padding: const EdgeInsets.symmetric(vertical: 13), child: Row(children: [
                    Container(
                      width: 38, height: 38,
                      decoration: BoxDecoration(color: (isIn ? AppColors.green : AppColors.red).withOpacity(0.15), shape: BoxShape.circle),
...
class _MiniChart extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final paint = Paint()..color = Colors.white.withOpacity(0.65)..strokeWidth = 2..style = PaintingStyle.stroke..strokeCap = StrokeCap.round..strokeJoin = StrokeJoin.round;
    final fill = Paint()..shader = LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Colors.white.withOpacity(0.12), Colors.transparent]).createShader(Rect.fromLTWH(0, 0, size.width, size.height))..style = PaintingStyle.fill;
