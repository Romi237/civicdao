    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          // Proposer
          Row(children: [
            const UserAvatar(initials: 'AM', color: AppColors.purple, size: 38),
            ...
            const Spacer(),
            const Text('May 12, 2024', style: TextStyle(color: AppColors.textMuted, fontSize: 12)),
          ]),
            ...
            AppCard(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  const Text('Current Results', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w600)),
          ...
          Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            AnimatedBuilder(animation: _checkCtrl, builder: (_, __) => Opacity(
              ...
              child: Transform.scale(scale: _scale.value, child: Container(
                ...
                decoration: BoxDecoration(shape: BoxShape.circle, color: AppColors.green, boxShadow: [BoxShadow(color: AppColors.green.withOpacity(0.35), blurRadius: 30, spreadRadius: 10)]),
