      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          child: Row(children: _categories.map((c) => GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: _category == c ? AppColors.purple.withOpacity(0.2) : AppColors.card,
                borderRadius: BorderRadius.circular(10),
                border: Border.all(color: _category == c ? AppColors.purple.withOpacity(0.5) : AppColors.border),
              ),
          ...
          return Expanded(child: GestureDetector(
            ...
            child: Container(
              ...
              child: Column(children: [
                ...
                Text('${d == 1 ? '1 day' : '$d days'}', style: TextStyle(color: sel ? AppColors.purple.withOpacity(0.8) : AppColors.textMuted, fontSize: 10)),
              ]),
            ),
          ));
        }).toList()),
        ...
        AppCard(
          child: Row(children: [
            ...
            const Expanded(child: Text('This proposal requires 51% quorum to pass. You need 100 CIVIC minimum to submit.', style: TextStyle(color: AppColors.textSecondary, fontSize: 12, height: 1.5))),
          ]),
        ),
  ...
  Widget _successView() {
    return Center(
      child: Padding(padding: const EdgeInsets.all(24), child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Container(width: 80, height: 80, decoration: BoxDecoration(color: AppColors.green.withOpacity(0.15), shape: BoxShape.circle), child: const Icon(Icons.check_circle_outline_rounded, color: AppColors.green, size: 48)),
