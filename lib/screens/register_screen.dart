            ...
            children: [
              ...
              AppCard(
                child: Column(
                  ...
                  children: [
                    Row(children: [
                      const Icon(Icons.account_balance_wallet_outlined, color: AppColors.purple, size: 18),
                      const SizedBox(width: 8),
                      const Text('Connect wallet', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w600)),
                      const SizedBox(width: 8),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: _walletConnected ? AppColors.green.withOpacity(0.15) : AppColors.border.withOpacity(0.3),
                          borderRadius: BorderRadius.circular(10),
                          border: Border.all(color: _walletConnected ? AppColors.green.withOpacity(0.4) : AppColors.border),
                        ),
                        child: Text(
