            ...
            Container(
              ...
              child: Row(children: [
                const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('Your Voting Power', style: TextStyle(color: Colors.white70, fontSize: 13)),
                  SizedBox(height: 8),
                  Text('1,250 CIVIC', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold)),
                  SizedBox(height: 4),
                  Text('≈ \$562.50', style: TextStyle(color: Colors.white60, fontSize: 13)),
                ])),
                Container(width: 60, height: 60, decoration: BoxDecoration(color: Colors.white.withValues(alpha: 0.15), shape: BoxShape.circle), child: const Icon(Icons.toll_rounded, color: Colors.white, size: 30)),
              ]),
            ),
            const SizedBox(height: 20),
