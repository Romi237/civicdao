    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _Step(num: '1', title: 'Choose a delegate', desc: 'Pick a trusted member to vote on your behalf.'),
          _Step(num: '2', title: 'Set the scope', desc: 'All proposals, or specific categories only.'),
          _Step(num: '3', title: 'Revoke anytime', desc: 'You can take back your votes at any time.', last: true),
          const SizedBox(height: 24),
                  ...
                  GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: isDelegated ? AppColors.green.withOpacity(0.2) : AppColors.purple.withOpacity(0.15),
                        borderRadius: BorderRadius.circular(10),
                        border: Border.all(color: isDelegated ? AppColors.green.withOpacity(0.4) : AppColors.purple.withOpacity(0.3)),
                      ),
