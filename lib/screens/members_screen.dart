          ...
          child: Row(children: ['All', 'Council', 'Active', 'Inactive'].map((f) => GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: _filter == f ? AppColors.purple.withValues(alpha: 0.2) : AppColors.card,
                borderRadius: BorderRadius.circular(20),
                border: Border.all(color: _filter == f ? AppColors.purple.withValues(alpha: 0.5) : AppColors.border),
              ),
