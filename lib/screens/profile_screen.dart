      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          AppCard(
            ...
            child: Row(children: [
              const Expanded(child: _StatCell(value: '1,250', label: 'Voting Power')),
              Container(width: 1, height: 40, color: AppColors.border),
              const Expanded(child: _StatCell(value: '12', label: 'Proposals Voted')),
              Container(width: 1, height: 40, color: AppColors.border),
              const Expanded(child: _StatCell(value: '85%', label: 'Participation')),
            ]),
          ),
          const SizedBox(height: 22),
          // Participation score
          ...
          AppCard(
            child: Row(children: [
              const SizedBox(width: 82, height: 82, child: CustomPaint(painter: _RingPainter(0.85), child: Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                ...[
                  ...
                  Container(width: 16, height: 16, decoration: BoxDecoration(color: AppColors.green.withValues(alpha: 0.2), shape: BoxShape.circle), child: const Icon(Icons.check, color: AppColors.green, size: 10)),
          ...
          GestureDetector(
            ...
            child: AppCard(
              child: Row(children: [
                Container(width: 40, height: 40, decoration: BoxDecoration(color: AppColors.purple.withValues(alpha: 0.15), borderRadius: BorderRadius.circular(10)), child: const Icon(Icons.share_outlined, color: AppColors.purple, size: 20)),
...
class _ActivityRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(children: [
      Container(width: 36, height: 36, decoration: BoxDecoration(color: color.withValues(alpha: 0.15), shape: BoxShape.circle), child: Icon(icon, color: color, size: 16)),
      const SizedBox(width: 12),
      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
...
class _RingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(c, r, Paint()..color = Colors.white.withValues(alpha: 0.08)..style = PaintingStyle.stroke..strokeWidth = 8);
